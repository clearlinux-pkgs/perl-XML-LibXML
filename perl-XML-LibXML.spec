...
Source0  : https://cpan.metacpan.org/authors/id/S/SH/SHLOMIF/XML-LibXML-2.0210.tar.gz
...
Patch1: backport-bee8338fd1cbd7aad4bf60c2965833343b6ead6f.patch
...
%prep
%setup -q -n XML-LibXML-2.0210
cd %{_builddir}
tar xf %{_sourcedir}/libxml-libxml-perl_2.0134+dfsg-1.debian.tar.xz
cd %{_builddir}/XML-LibXML-2.0210
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/XML-LibXML-2.0210/deblicense/
%patch -P 1 -p1
pushd ..
cp -a XML-LibXML-2.0210 buildavx2
popd
...
cp %{_builddir}/XML-LibXML-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-XML-LibXML/b4cd683c5038b733456bfbb680f75fb1e711599a || :
cp %{_builddir}/XML-LibXML-%{version}/debian/copyright %{buildroot}/usr/share/package-licenses/perl-XML-LibXML/e5387b6e32d15d2a5a50b4600f520f1e2665bb8b || :
