...
Source0  : https://cpan.metacpan.org/authors/id/S/SH/SHLOMIF/XML-LibXML-2.0208.tar.gz
...
%prep
%setup -q -n XML-LibXML-2.0208
cd %{_builddir}
tar xf %{_sourcedir}/libxml-libxml-perl_2.0134+dfsg-1.debian.tar.xz
cd %{_builddir}/XML-LibXML-2.0208
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/XML-LibXML-2.0208/deblicense/
