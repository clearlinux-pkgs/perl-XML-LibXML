...
cp %{_builddir}/XML-LibXML-2.0201/LICENSE %{buildroot}/usr/share/package-licenses/perl-XML-LibXML/b4cd683c5038b733456bfbb680f75fb1e711599a
cp %{_builddir}/XML-LibXML-2.0201/debian/copyright %{buildroot}/usr/share/package-licenses/perl-XML-LibXML/e5387b6e32d15d2a5a50b4600f520f1e2665bb8b
cp %{_builddir}/XML-LibXML-2.0201/deblicense/copyright %{buildroot}/usr/share/package-licenses/perl-XML-LibXML/b8d8e3d6cebbef14f46031c868317e6820c9cc34
if test -f Makefile.PL; then
