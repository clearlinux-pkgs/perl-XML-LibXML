...
Version  : 2.0133
Release  : 10
URL      : https://cpan.metacpan.org/authors/id/S/SH/SHLOMIF/XML-LibXML-2.0133.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/S/SH/SHLOMIF/XML-LibXML-2.0133.tar.gz
...
%prep
%setup -q -n XML-LibXML-2.0133
cd ..
%setup -q -T -D -n XML-LibXML-2.0133 -b 1
mkdir -p deblicense/
cp -r %{_topdir}/BUILD/debian/* %{_topdir}/BUILD/XML-LibXML-2.0133/deblicense/
